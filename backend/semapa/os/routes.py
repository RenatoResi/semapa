...
from semapa.models import SessionLocal, OrdemServico, Requerimento
from datetime import datetime

os_bp = Blueprint('os', __name__)

@os_bp.route('/ordens_servico', methods=['GET', 'POST'])
@login_required
def ordens_servico():
...
@os_bp.route('/ordens_servico/<int:id>', methods=['PUT'])
@login_required
...
@os_bp.route('/ordens_servico/<int:id>', methods=['GET'])
@login_required
