from sqlalchemy import Column, Integer, String, ForeignKey, DateTime, Text, Float, Table, LargeBinary
...
class Especies(Base):
    ...
    fruto_comestivel = Column(String(10))
    epoca_frutificacao = Column(String(50))
    necessidade_rega = Column(String(20))
    atrai_fauna = Column(String(10))
    observacoes = Column(Text)
    link_foto = Column(String(200))
